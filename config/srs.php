 ...
 * Time: 14:14
 */
//$host=config('app.url').'/Api/V1/Srs';
//$debug="?XDEBUG_SESSION_START=11206";
$host='http://127.0.0.1:8085';//不要瞎改
$debug="";
return [
    'listen'=>'1935;',//监听端口
    'max_connections'=>'1000;',//最大连接数
    'daemon'=>'off;',//后台启动 on|off
    'pid'=>storage_path('/tem/pids/srs.pid').';',//pid文件路径
    'ff_log_dir'=>storage_path('/tem/logs/ff_log').';',//日志目录。如果启用ffmpeg，每个转码流将创建一个日志文件。 /dev/null禁用日志。默认./objs。
    'srs_log_tank'=>'console;',//日志文件打印位置  console|file
    'srs_log_level'=>'error;',//日志级别 从高到低 verbose|info|trace|warn|error
    'srs_log_file'=>storage_path('/tem/logs/srs/srs_log.log').';',//日志文件位置
    'heartbeat'=>[//心跳
        'enabled'=>'off;',// on|off
    ...
    'vhost __defaultVhost__'=>[
        ...
        'hls'=>[//
            ...
            'hls_path'=>storage_path('/video').';',//当hls写到磁盘时，指定写入的目录。
